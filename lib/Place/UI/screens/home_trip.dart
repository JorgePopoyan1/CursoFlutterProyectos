...
class HomeTrips extends StatelessWidget {
  ...
  String descriptionDummy =
      ...
      "silencio, de manera similar a un tranquilo espejo del paraíso. La Laguna Brava es un hermoso destino natural ubicado en el municipio de Nentón, Huehuetenango. \n\n  A 1142 metros de altura sobre el nivel del mar, rodeada por grandes sierras con diversa vegetación característica del altiplano guatemalteco, forma parte de una serie de 60 lagos, lagunas y cenotes que se distribuyen entre el noroccidente de Guatemala y parte de Chiapas, México.";
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget> [
        ListView(
          children: [
            DescriptionPlace("Laguna Brava", 4, descriptionDummy),
            ReviewList()
          ],
        ),
        HeaderAppBar()
