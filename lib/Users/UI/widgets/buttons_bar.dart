    ...
    return Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            BarButtonCircle(true, Icons.vpn_key, 20.0, Color.fromRGBO(
                245, 219, 0, 1.0)
                , () => {}),
            //Añadiremos un nuevo lugar
            BarButtonCircle(false, Icons.add, 40.0, Color.fromRGBO(
                47, 227, 22, 1.0),
                    ()  {
              File image;
            ...
            //Cerrar Sesión
            BarButtonCircle(true, Icons.exit_to_app, 20.0, Color.fromRGBO(
                255, 10, 10, 0.6),
                    () => {
                  userBloc.signOut()
                }),
